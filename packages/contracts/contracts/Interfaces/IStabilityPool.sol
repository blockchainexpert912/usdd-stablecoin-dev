...
interface IStabilityPool {
     ...
     */
    function withdrawFromSP(address _depositor, uint256 _amount) external;
     ...
     */
    function withdrawCollGainToTrove(address _upperHint, address _lowerHint) external;
    ...
    /*
     * Returns USDD held in the pool. Changes when users deposit/withdraw, and when Trove debt is offset.
     */
    function getTotalUSDDDeposits() external view returns (uint256);
     ...
     */
    function getDepositorDEFTGain(address _depositor) external view returns (uint256);

    /*
     * Return the DEFT gain earned by the front end.
     */
    function getFrontEndDEFTGain(address _frontEnd) external view returns (uint256);

    /*
     * Return the user's compounded deposit.
     */
    function getCompoundedUSDDDeposit(address _depositor) external view returns (uint256);
    ...
    /*
     * Fallback function
     * Only callable by Active Pool, it just accounts for Coll received
