...
contract("Gas cost tests", async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 USDD
    ...
    //1 accts open Trove with 1 ether and withdraw 100 USDD
    ...
    // Account 500 opens with 1 ether and withdraws 100 USDD
    ...
    // Check initial troves with starting 10E/90USDD are still open
    for (account of accounts.slice(101, 111)) {
      assert.isTrue(await sortedTroves.contains(account));
    }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 USDD
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 USDD
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 USDD
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 USDD
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 USDD
    await th.openTrove_allAccounts(
      accounts.slice(101, 111),
      contracts,
      dec(10, "ether"),
    ...
    //20 accts open Trove with 1 ether and withdraw 100 USDD
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 USDD
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 USDD
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 USDD
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion USDD
    ...
    // Check SP has 9e28 USDD
    const USDDinSP = (await stabilityPool.getTotalUSDDDeposits()).toString();
    assert.equal(USDDinSP, dec(9, 28));

    //1 acct opens Trove with 1 ether and withdraw 100 USDD
    const _1_Defaulter = accounts.slice(1, 2);
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, "ether"), dec(60, 18));
    ...
    // Check initial troves with starting 10E/90USDD, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) {
      assert.isTrue(await sortedTroves.contains(account));
    }
    assert.isTrue(await sortedTroves.contains(whale));

    //Check USDD in SP has decreased but is still > 0
    const USDDinSP_After = await stabilityPool.getTotalUSDDDeposits();
    assert.isTrue(USDDinSP_After.lt(web3.utils.toBN(dec(9, 28))));
    assert.isTrue(USDDinSP_After.gt(web3.utils.toBN("0")));
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 USDD
    const _2_Defaulters = accounts.slice(1, 3);
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, "ether"), dec(60, 18));
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 USDD
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 USDD
    await borrowerOperations.openTrove(_100pct, dec(130, 18), accounts[500], ZERO_ADDRESS, {
      from: accounts[500],
      value: dec(1, "ether")
    });
