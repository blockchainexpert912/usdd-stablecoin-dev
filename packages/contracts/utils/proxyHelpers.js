...
class BorrowerOperationsProxy extends Proxy {
  ...
  async withdrawUSDD(...params) {
    return this.forwardFunction(params, "withdrawUSDD(uint256,uint256,address,address)");
  }

  async repayUSDD(...params) {
    return this.forwardFunction(params, "repayUSDD(uint256,address,address)");
  }
  ...
  async USDD_GAS_COMPENSATION(...params) {
    return this.proxyFunction("USDD_GAS_COMPENSATION", params);
  }
...
class BorrowerWrappersProxy extends Proxy {
  ...
  async claimCollateralAndOpenTrove(...params) {
    return this.forwardFunction(
      params,
      "claimCollateralAndOpenTrove(uint256,uint256,uint256,address,address)"
    );
  }
...
class TroveManagerProxy extends Proxy {
  ...
  async getPendingUSDDDebtReward(...params) {
    return this.proxyFunction("getPendingUSDDDebtReward", params);
  }
  ...
  async L_USDDDebt() {
    return this.proxyFunction("L_USDDDebt", []);
  }
...
class StabilityPoolProxy extends Proxy {
  ...
  async getCompoundedUSDDDeposit(user) {
    return this.proxyFunctionWithUser("getCompoundedUSDDDeposit", user);
  }
  ...
  async getDepositorETHGain(user) {
    return this.proxyFunctionWithUser("getDepositorCollGain", user);
  }
}
...
class DEFTStakingProxy extends Proxy {
  constructor(owner, proxies, tokenScriptAddress, token) {
    super(owner, proxies, tokenScriptAddress, token);
  }
  ...
  async F_USDD(user) {
    return this.proxyFunctionWithUser("F_USDD", user);
  }
}
