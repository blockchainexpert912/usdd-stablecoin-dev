...
interface CommunityIssuanceTransactions {
  ...
  start(_LQTYSupplyCap: BigNumberish, _overrides?: Overrides): Promise<void>;
}
...
interface UnipoolTransactions {
  ...
  setAddresses(_lqtyTokenAddress: string, _uniTokenAddress: string, _overrides?: Overrides): Promise<void>;
  stake(amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  start(_reward: BigNumberish, _duration: BigNumberish, _overrides?: Overrides): Promise<void>;
